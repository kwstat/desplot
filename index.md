...
`desplot` makes it easy to plot experimental designs of field trials in
agriculture.
...
This data is is from a split-plot experiment with 6 replicates. The
replicates are shown by the colored regions and outlined by the thick
lines. The text codes and the thin lines define the whole-plots. The
...
![desplot](reference/figures/yates_oats_design.png?raw=true)
...
![desplot](reference/figures/yates_oats_design_ggplot.png?raw=true)

desplot

## Example 2

Another very useful technique is to color the cells according to a
...
![desplot](reference/figures/yates_oats_yield.png?raw=true)

desplot

## Example 3

Multiple locations can be shown in a single figure. Data quality for
each cell can be indicated with a slash drawn across questionable values
...
![desplot](reference/figures/besag_met_missing.png?raw=true)

desplot

### Logo note

The hexagon logo for this package shows a simple experimental design
layout on top of a tan (soil-color) background.
